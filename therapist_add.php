  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
    <div class="modal-content">
      <div class="modal-header alert-light">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa-solid fa-user-large"></i> Create therapist</h5>
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
              <div class="form-group">
                ...
                <input type="text" class="form-control form-control-sm"  placeholder="First name" name="Nationality" required onkeyup="lettersOnly(this)">
              </div>
          </div>
          ...
          <div class="col-lg-4">
              <div class="form-group">
                <label>Therapist proof (Image)</label>
      ...
      <div class="modal-footer alert-light">
        ...
        <button type="submit" class="btn btn-primary" name="create_therapist" id="create"><i class="fa-solid fa-floppy-disk"></i> Submit</button>
      </div>
      </form>
    </div>
  </div>
