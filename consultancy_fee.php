<title>Consultancy Fee | St. Vincent de Ferrer College Of Camarin, Inc.</title>
...
?>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody id="users_data">
                    <tr>
                      <?php 
                        $i = 1;
                        $sql = mysqli_query($conn, "SELECT * FROM consultancy_fee JOIN therapist ON consultancy_fee.consult_fee_therapist_Id=therapist.therapist_Id");
                        while ($row = mysqli_fetch_array($sql)) {
                      ?>
                        <td><?php echo $i++; ?></td>
                        <td><?php echo ' '.$row['firstname'].' '.$row['middlename'].' '.$row['lastname'].' '.$row['suffix'].' '; ?></td>
                        <td><?php echo $row['consult_fee']; ?></td>
                        <td>
                            <div class="dropdown dropleft">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                     <button type="button" class="btn btn-primary dropdown-item" data-toggle="modal" data-target="#update<?php echo $row['consult_fee_Id']; ?>">Update</button>
                                     <button type="button" class="btn btn-primary dropdown-item" data-toggle="modal" data-target="#delete<?php echo $row['consult_fee_Id']; ?>">Delete</button>
                                </div>
                            </div>
                        </td> 
                    </tr>

                    <?php include 'consultancy_fee_update_delete.php'; } ?>
 ...
 <?php include 'consultancy_fee_add.php'; ?>
