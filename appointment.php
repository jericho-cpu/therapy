<title>Appointments | St. Vincent de Ferrer College Of Camarin, Inc.</title>
...
?>
                  ...
                  <tbody id="users_data">
                    <tr>
                      <?php 
                        ...
                        $sql = mysqli_query($conn, "SELECT * FROM new_appointment JOIN therapist ON new_appointment.appointment_therapist_Id=therapist.therapist_Id JOIN patient ON new_appointment.appointment_patient_Id=patient.patient_Id");
                      ...
                      ?>
                        ...
                        <td>
                          ...
                          <span type="button" class="badge badge-warning rounded-pill p-1" data-toggle="modal" data-target="#confirm<?php echo $row['appointment_Id']; ?>">Set as confirmed</span>
                          <?php else: ?>
                            ...
                            <!-- <div class="dropdown dropleft">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      <?php //if($row['appointment_status'] !='Confirmed'): ?>
                                        <button type="button" class="btn btn-primary dropdown-item" data-toggle="modal" data-target="#confirm<?php //echo $row['appointment_Id']; ?>">Set as confirmed</button>
                                      <?php //endif; ?>
                    ...
                    <?php include 'appointment_delete.php'; include 'paid_patients_confirmation.php';
                  }
                     ?>
 ...
 <?php include 'appointment_add.php';  ?>
