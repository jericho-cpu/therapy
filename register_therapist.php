...
<!-- ======= Appointment Section ======= -->
    <section id="register_therapist" class="appointment section-bg">
        ...
        <form action="register_code.php" method="post" class="bg-body pb-4" enctype="multipart/form-data">
          <div class="row bg-body p-3">
            ...
            <!-- <div class="col-md-12 form-group mt-3 mb-3">
              <label for=""><b>Credential images</b></label>
              <input type="file" class="form-control" name="Credential[]" required multiple>
            </div> -->
            <div class="col-md-6 form-group mt-3">
              <label for=""><b>Therapist proof (Image)</b></label>
         ...
         <!--  <div class="form-group mt-3">
          ...
          <div class="text-center"><button class="btn btn-primary" type="submit" name="create_therapist">Register</button></div>
        </form>
