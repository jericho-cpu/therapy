<title>Profile | St. Vincent de Ferrer College Of Camarin, Inc.</title>
                     ...
                     <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12 mb-4 d-flex justify-content-center">
                                <img src="../images-patient/<?php echo $row['image']; ?>" alt="" width="100" style="height: 100px; border-radius: 50%;">
                            </div>
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control form-control-sm" value="<?php echo $row['disease_type']; ?>" name="disease" readonly>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
