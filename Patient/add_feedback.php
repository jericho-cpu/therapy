<!-- ****************************************************DELETE*********************************************************************** -->
<!-- Modal -->
<div class="modal fade" id="message<?php echo $row['new_payment_Id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer alert-light">
        ...
        <button type="submit" class="btn btn-primary" name="add_comment">Send</button>
      </div>
        </form>
    </div>
  </div>
