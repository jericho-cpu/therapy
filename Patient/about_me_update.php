<title>Profile Update | St. Vincent de Ferrer College Of Camarin, Inc.</title>
            ...
            <div class="card card-primary">
              ...
              <form action="process_update.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control form-control-sm" name="disease" value="<?php echo $row['disease_type']; ?>" name="disease">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary" name="update_patient"><i class="fa-solid fa-floppy-disk"></i> Update</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
